...
<title>Más Q'Fresco - Productos</title>
    <!-- SEO Meta Tags-->
          ...
          <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-dark flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li class="breadcrumb-item text-muted text-nowrap active" aria-current="page">Productos</li>
              </ol>
            </nav>
          </div>
          <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
            <h1 class="h3 text-dark mb-0">Tienda</h1>
          </div>
        </div>
      </div>
            ...
            <div class="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
              <div class="d-flex flex-wrap">
                <div class="d-flex align-items-center flex-nowrap me-3 me-sm-4 pb-3">
                  <label class="text-muted opacity-75 text-nowrap fs-sm me-2 d-none d-sm-block" for="sorting">Ordenar por:</label>
                  <select class="form-select" id="sorting">
                    <option>Popularidad</option>
                    <option>Bajo - Alto Precio</option>
                    <option>Alto - Bajo Precio</option>
                  </select><span class="fs-sm text-dark opacity-75 text-nowrap ms-2 d-none d-md-block"><?php
...
?> productos</span>
              ...
              <div class=" d-sm-flex pb-3"><a class="btn btn-icon nav-link-style bg-light text-dark disabled opacity-100 me-2" href="#"><i class="ci-view-grid"></i></a><a class="btn btn-icon nav-link-style nav-link-light" href="#"><i class="text-muted ci-view-list"></i></a></div>
            </div>
...
$sql = "SELECT * FROM productos WHERE stock > 0 ORDER BY id_producto DESC LIMIT $offset, $products_per_page";
...
if (isset($_SESSION['user_id'])) {
    ...
    <script src="js/theme.min.js"></script>
        ...
        <script>
// Ocultar el preloader después de un retraso de 3 segundos cuando la página haya cargado completamente
