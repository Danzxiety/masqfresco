          ...
          <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-dark flex-lg-nowrap justify-content-center justify-content-lg-start">
                <li class="breadcrumb-item"><a class="text-nowrap text-muted" href="index"><i class="ci-home"></i>Inicio</a></li>
                <li class="breadcrumb-item text-nowrap text-muted"><a href="index">Carrito</a>
                </li>
        ...
        <div class="row">
          <section class="col-lg-8">
             ...
             <div class="steps steps-light pt-2 pb-3 mb-5"><a class="step-item active text-dark" href="">
                ...
                <div class="step-progress" style="background-color: rgb(37, 180, 80); color:white;"><span class="step-count" style="background-color: rgb(37, 180, 80); color:white;" >4</span></div>
