...
<div class="card border-0 rounded-4 p-3 shadow">
              <div class="card-body">
                ...
                <p class="fs-base pt-4 pb-2">Rellene los suiguentes datos</p>
                <form class="needs-validation" method="post" action="funtions" enctype="multipart/form-data" novalidate="">
                <input type="hidden" name="form_name" value="form_use">
                  <div class="input-group mb-3"><i class="ci-user position-absolute top-50 translate-middle-y text-muted fs-base ms-3"></i>
                    <input class="form-control rounded-start" type="text" name="nombre" placeholder="Nombre" required="">
                  </div>
                  <div class="input-group mb-3"><i class="ci-user position-absolute top-50 translate-middle-y text-muted fs-base ms-3"></i>
                    <input class="form-control rounded-start" type="text" name="apellido" placeholder="Apellidos" required="">
                  </div>
...
<select class="form-select dark" name="codigo_pais" id="country-code" required="">
    ...
    <!-- Agrega más opciones para otros países aquí -->
                  ...
                  <div class="input-group mb-3"><i class="ci-user position-absolute top-50 translate-middle-y text-muted fs-base ms-3"></i>
                    <input class="form-control rounded-start" type="tel" name="numero_tel" placeholder="Teléfono" required="">
                  </div>
                
                  <div class="input-group mb-3"><i class="ci-mail position-absolute top-50 translate-middle-y text-muted fs-base ms-3"></i>
                    <input class="form-control rounded-start" type="email" name="correo_electronico" placeholder="Correo" required="">
                  </div>
                  ...
                  <div class="input-group mb-3"><i class="ci-locked position-absolute top-50 translate-middle-y text-muted fs-base ms-3"></i>
                    <div class="password-toggle w-100">
                      <input class="form-control" type="password"  name="confirmar_contrasena"  placeholder="Confirmar ontraseña" required="">
                      <label class="password-toggle-btn" aria-label="Show/hide password">
                        <input class="password-toggle-check" type="checkbox"><span class="password-toggle-indicator"></span>
                      </label>
                    </div>
                  ...
                  <div class="d-flex flex-wrap justify-content-between">
                    ...
                    <input class="form-check-input" type="checkbox" required id="remember_me">
                      <label class="form-check-label" for="remember_me">Aceptar nuestros <a class="text-primary" href="terms">términos y condiciones</a>!</label>
                    </div>
                  </div>
                  <p>Ya tienes una cuenta? <span><a class="text-primary" href="login">Inicia Sesión</a></span></p>
                  <hr class="mt-4">
                  <div class="text-end pt-4">
                    <button class="btn btn-primary" type="submit"><i class="ci-sign-in me-2 ms-n21"></i>Registrarse</button>
                  </div>
                </form>
              </div>
            </div>
